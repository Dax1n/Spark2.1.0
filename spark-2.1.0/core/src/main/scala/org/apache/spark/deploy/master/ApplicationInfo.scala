...
private[spark] class ApplicationInfo(
  ...
  /**
    ...
    * application will this be set to a finite value. This is used for dynamic allocation.<br><br>
    *  应用程序在给定时间内的executor的上限，默认是无上限的，当一个分配请求被发出之后会设置一个有限数值，这么做的目的是为了动态分配<br><br>
    *   spark有关于动态资源分配的配置，参见：http://blog.csdn.net/dax1n/article/details/68954156
    */
