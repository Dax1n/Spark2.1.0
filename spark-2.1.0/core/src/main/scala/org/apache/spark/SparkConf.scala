...
class SparkConf(loadDefaults: Boolean) extends Cloneable with Logging with Serializable {
  ...
  /**
    * Create a SparkConf that loads defaults from system properties and the classpath<br><br>创建一个SparkConf，默认加载Saprk/Conf中的默认配置属性
    *
    * @return
    */
  def this() = this(true)
  ...
  /**
    * 加载默认的Spark-default.conf配置文件，加载以spark.开始的配置
    *
    * @param silent
    * @return
    */
