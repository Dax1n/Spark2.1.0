...
private[streaming] class BlockGenerator(
  ...
  //TODO StreamContext需要设置批次时间，而Block间隔是指在每一个批次中生成Block时候的间隔
  private val blockIntervalMs = conf.getTimeAsMs("spark.streaming.blockInterval", "200ms")

  require(blockIntervalMs > 0, s"'spark.streaming.blockInterval' should be a positive value")

  //TODO  blockIntervalTimer把数据合并为block
  ...
  //TODO blockPushingThread把合并后的block通过BlockManager来存储
  ...
  /** Change the buffer to which single records are added to.<br><br>
  ...
  /** Keep pushing blocks to the BlockManager.
    * <br><br>持续将block块push到BlockManager
    */
