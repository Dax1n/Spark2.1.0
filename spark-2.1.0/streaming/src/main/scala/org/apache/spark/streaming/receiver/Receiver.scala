...
/**
  * Receiver具有一个ReceiverSupervisor成员
  *
  * @param storageLevel
  * @tparam T
  */
...
abstract class Receiver[T](val storageLevel: StorageLevel) extends Serializable {
  ...
  /**
    ...
    * <br><br><br>
    * 将接收到的单个记录存储到Spark内存中，在存储到Spark内存之前这些单个记录会被聚集到一起组成数据块
    */
  ...
  /**
    ...
    * <br><br>
    * Receiver的监督者，ReceiverSupervisor
    */
  ...
  /** Attach Network Receiver executor to this receiver.
    * <br><br>
    * org.apache.spark.streaming.receiver.Receiver#attachSupervisor(org.apache.spark.streaming.receiver.ReceiverSupervisor) */
  .
